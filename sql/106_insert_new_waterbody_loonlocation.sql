/* 
  This script creates new rows in vt_water_body and vt_loon_locations for incoming survey data
  at those new locations. In these initial cases, the 2008 data includes the new locations.
*/
...
--Doesn't exist. 
--Create new waterBody & loonLocation 'Quechee Gorge Dam'
...
--TO-do: Add a Quechee Gorge Dam polygon to the GeoJSON layer vt_water_body_geo
...
--Create new waterBody & loonLocation 'Taftsville Dam'
--There isn't an official VT Water Body, so the feature will not reside within that GeoJSON layer,
--meaning it can't be searched on the loon map.
--TO-do: Add a Taftsville Dam polygon to the GeoJSON layer vt_water_body_geo
CREATE TEMP TABLE tmp (like vt_water_body);
INSERT INTO tmp SELECT * FROM vt_water_body WHERE wbTextId = 'ABENAKI';
UPDATE tmp SET 
...
--Add loon location Sabin (Woodbury) in town Calais mapped to waterBodyId SABIN
INSERT INTO vt_loon_locations (locationName, locationTown, locationRegion, locationArea, waterBodyId, locationTownId, exportName)
VALUES(
	'Sabin (Woodbury)',
	'Calais',
...
--Add loon location Waterbury in town Waterbury mapped to waterBodyId WATERBURY
INSERT INTO vt_loon_locations (locationName, locationTown, locationRegion, locationArea, waterBodyId, locationTownId, exportName)
VALUES(
	'Waterbury',
	'Waterbury',
