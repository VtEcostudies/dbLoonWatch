-- Create a view for loonwatch sampling event data
-- NOTE: these are used by our IPT to generate Darwin Core Archives
...
-- Create a view for loonwatch sampling occurrence data
-- NOTE: these are used by our IPT to generate Darwin Core Archives
